...
CREATE table TRANSACTION(
	...
	CONSTRAINT product_branch_id_fk FOREIGN KEY(Branch_id)
...
CREATE table PROMOSTAR(
	...
	CONSTRAINT promostar_card_number_fk FOREIGN KEY(Card_number)
		REFERENCES CUSTOMER(Card_number)
);
...
CREATE table PRODUCT_SPENT_PROMOSTAR(
	Transaction_number int(10),
	Control_number int(10),
	CONSTRAINT product_spent_promostar_transaction_number_pk PRIMARY 
		KEY(Transaction_number),
	CONSTRAINT product_spent_promostar_control_number_fk FOREIGN 
		KEY(Control_number) REFERENCES PROMOSTAR(Control_number)
);

CREATE table PRODUCT_ACCUMULATED_PROMOSTAR(
	Transaction_number int(10),
	Control_number int(10),
	CONSTRAINT product_accumulated_promostar_transaction_number_pk PRIMARY 
		KEY(Transaction_number),
	CONSTRAINT product_accumulated_promostar_control_number_fk FOREIGN 
		KEY(Control_number) REFERENCES PROMOSTAR(Control_number)
);
